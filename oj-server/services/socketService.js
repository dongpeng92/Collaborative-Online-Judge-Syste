...
module.exports = function (io) {
    ...
    io.on('connection', socket => {
            ...
            redisClient.get(sessionPath + '/' + sessionId, function (data) {
                if(data) {
                    ...
                    collaborations[sessionId] = {
                        'cachedChangeEvent': JSON.parse(data),
                        'participants': []
                    };
                } else {
        ...
        socket.on('change', delta => {
            ...
            if(sessionId in collaborations) {
                collaborations[sessionId]['cachedChangeEvent'].push(["change", delta, Date.now()]);
            }
            ...
            if(sessionId in collaborations) {
                ...
                if(index >= 0){
                    ...
                    if(participants.length == 0) {
                        ...
                        let value = JSON.stringify(collaborations[sessionId]['cachedChangeEvent']);
